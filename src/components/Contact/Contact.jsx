  ...
  return (
    <div className="popup">
      <form className="form">
        ...
        <div className="note">
          <label className="title">Suscribite a nuestra lista de precios</label>
          <span class="subtitle">Suscribite a nustras actualizaciones de lista para obtener nuestros precios al instante.</span>
        </div>
        <input placeholder="Ingresa tu e-mail" title="Ingresa tu e-mail" name="email" type="email" className="input_field"/>
